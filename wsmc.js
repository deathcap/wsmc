...
(function() {
  var WebSocketServer, argv, i, ids, mc, sids, states, wss;

  mc = require('minecraft-protocol');

  WebSocketServer = (require('ws')).Server;

  argv = (require('optimist'))["default"]('wshost', '0.0.0.0')["default"]('wsport', 1234)["default"]('mchost', 'localhost')["default"]('mcport', 25565).argv;
  ...
  wss.on('connection', function(ws) {
    ...
    client = mc.createClient({
      host: argv.mchost,
      port: argv.mcport,
      username: ((i % 2) === 0 ? 'webuser' : 'Player1'),
      password: null
    });
    i += 1;
